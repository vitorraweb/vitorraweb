...
import {
  Zap, ShieldCheck, PackageCheck, Briefcase,
  Building2, Ambulance, Shield, HeartHandshake, Stethoscope,
...
const faqs = [
  ...
  { q: "How do I get specifications?",           a: "Request product information and our team will provide the full specifications, certifications, and compliance documentation for your review." },
];
  ...
  return (
    <>
      ...
      <main className="flex-1" style={{ backgroundColor: "#F2F2F2" }}>
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto w-full px-6 md:px-12 lg:px-20 pb-16 md:pb-24">
            <Reveal>
              ...
              <div className="flex flex-wrap gap-2 mb-9">
                {["Clinical-grade", "Single-use & sterile", "Procurement-ready", "Field-tested"].map((f) => (
                  <span
                    key={f}
                    style={{
          ...
          <div className="container-max grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal direction="right">
              <ParallaxImage
                ...
                alt="Gloved hand holding SEAL wound spray in a clinical setting"
        ...
        {/* ══ WHO IT'S FOR ════════════════════════════════════════════════════
            Light centered — mirrors FET audiences + homepage sectors strip.
        ═══════════════════════════════════════════════════════════════════════ */}
