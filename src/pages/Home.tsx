...
export default function Home() {
  ...
  return (
    <div className="w-full bg-vitorra-bg min-h-screen text-vitorra-text transition-colors duration-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full mb-20 md:mb-40">
          ...
          >
            ...
            <h1 className="mb-8">
              ...
              <span className="text-vitorra-gold font-bold">{pageContent.homeHeroSubtitle}</span>
            </h1>

            <p className="text-vitorra-text/70 mb-10 max-w-xl leading-relaxed font-normal whitespace-pre-line">
              {pageContent.homeHeroDescription}
            </p>

            <div className="flex flex-wrap gap-4">
              <Link to="/about" className="px-6 py-3 bg-vitorra-gold text-vitorra-gold-text font-bold rounded-lg hover:bg-vitorra-text hover:text-vitorra-bg transition-all duration-300 uppercase tracking-[0.2em] text-[10px] shadow-xl shadow-vitorra-gold/20">
                Explore Vitorra
              </Link>
            </div>
          </motion.div>
      ...
      <section className="py-24 bg-vitorra-bg-alt border-t border-vitorra-border transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div>
              <h2 className="mb-6">{pageContent.ecosystemTitle}</h2>
              <div className="w-24 h-px bg-vitorra-gold" />
            </div>
            <p className="text-vitorra-muted max-w-md text-lg whitespace-pre-line">
      ...
      <section className="py-24 bg-vitorra-bg border-t border-vitorra-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl md:text-4xl font-serif mb-8 text-vitorra-text">{pageContent.globalImpactTitle}</h2>
          <p className="text-vitorra-muted max-w-2xl mx-auto text-lg mb-16">
            {pageContent.globalImpactDescription}
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((item, i) => (
              <div key={i} className="p-6 rounded-2xl bg-vitorra-bg/5 backdrop-blur-md border border-vitorra-border shadow-sm">
                <div translate="no" className="text-3xl md:text-5xl font-serif text-vitorra-gold mb-2">{item.stat}</div>
                <div className="text-[10px] font-bold text-vitorra-muted uppercase tracking-widest">{item.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-vitorra-bg border-t border-vitorra-border">
            ...
            <div className="px-8 md:px-14 py-12 md:py-14">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
                ...
                <div className="flex-shrink-0">
                  <div className="w-24 h-24 md:w-28 md:h-28 rounded-full border-2 border-vitorra-gold/30 bg-vitorra-bg/50 flex items-center justify-center shadow-lg shadow-vitorra-gold/5">
                    <svg viewBox="0 0 64 64" className="w-14 h-14 md:w-16 md:h-16 text-vitorra-gold" fill="none" stroke="currentColor" strokeWidth="1.2">
                      {/* Shield shape */}
                ...
                <div className="flex-1 text-center md:text-left">
                  <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-vitorra-gold mb-3">
                    Republic of Uganda — Official Registration
                  </p>
                  <h3 className="text-xl md:text-2xl font-serif text-vitorra-text mb-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
                      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-vitorra-muted sm:min-w-[180px]">
                        Certificate of Incorporation
                      </span>
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 rounded-full bg-green-500 shadow-sm shadow-green-500/50" />
                        <span className="text-vitorra-text font-mono text-lg sm:text-2xl md:text-3xl font-bold tracking-widest break-all">80034340923220</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
                      ...
                      <span className="text-vitorra-text/80 text-sm">
