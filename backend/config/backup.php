...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // The application code lives in git, so we don't back it up.
                // We back up the live database (below) plus user-uploaded media
                // (blog covers, product images) which exist only on the server.
                'include' => [
     ...
     */
    'notifications' => [
        // Only email the team when something is WRONG — no daily success spam.
        'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', env('MAIL_TEAM_ADDRESS', 'support@vitorra.org')),
