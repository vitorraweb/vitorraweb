      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background:#FFFFFF; border-radius:20px; overflow:hidden; border:1px solid rgba(0,0,0,0.06);">
        ...
        <tr><td style="padding:32px;">
          ...
          <p style="font-size:15px; line-height:1.65; color:#454545; margin:0 0 22px;">
            A pipeline contact has been assigned to you.
          </p>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#FAFAF8; border:1px solid rgba(197,178,122,0.3); border-radius:14px; margin:0 0 24px;">
            <tr><td style="padding:18px 20px;">
              <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.1em; color:#999; margin-bottom:4px;">Contact</div>
              <div style="font-size:15px; font-weight:600; margin-bottom:14px;">{{ $contactName }} ({{ $contactEmail }})</div>
              <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.1em; color:#999; margin-bottom:4px;">Stage</div>
              <div style="font-size:14px; font-weight:600;">{{ $stageLabel }}</div>
            </td></tr>
          </table>

          <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
            <tr><td style="border-radius:999px; background:#C5B27A;">
              <a href="{{ $pipelineUrl }}" style="display:inline-block; padding:13px 30px; font-size:15px; font-weight:700; color:#1E1E1E; text-decoration:none; border-radius:999px;">View in Pipeline &rarr;</a>
            </td></tr>
          </table>

          <p style="font-size:13px; line-height:1.6; color:#999; margin:0;">
            If the button doesn't work, open this link:<br>
            <a href="{{ $pipelineUrl }}" style="color:#7A6020;">{{ $pipelineUrl }}</a>
          </p>
        </td></tr>
